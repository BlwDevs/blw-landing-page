...
<div class="w-24 h-8 bg-[#283039] rounded-md flex items-center justify-center">
<span class="text-white/50 text-sm font-medium">Logo BLW</span>
</div>
</div>
<div class="hidden md:flex flex-1 justify-end gap-8">
<div class="flex items-center gap-9">
<a class="text-white text-sm font-medium leading-normal hover:text-primary" href="#">Sobre nós</a>
<a class="text-white text-sm font-medium leading-normal hover:text-primary" href="#">Serviços</a>
<a class="text-white text-sm font-medium leading-normal hover:text-primary" href="#">Depoimentos</a>
<a class="text-white text-sm font-medium leading-normal hover:text-primary" href="#">Contato</a>
</div>
</div>
<div class="md:hidden">
...
<h1 class="text-white text-4xl sm:text-5xl font-black leading-tight tracking-[-0.033em]">
                                            Transforme sua ideia em software de impacto
                                        </h1>
<p class="text-white/80 text-base sm:text-lg font-normal leading-normal">
...
<div class="bg-[#1a2027] p-8 rounded-xl shadow-2xl">
<h3 class="text-white text-2xl font-bold mb-6 text-center">Fale com um especialista</h3>
<form class="space-y-4">
<div>
<label class="text-white/80 text-sm font-medium mb-2 block" for="name">Nome</label>
<input class="w-full bg-[#283039] border border-transparent rounded-lg text-white placeholder-white/50 focus:ring-primary focus:ring-2 focus:border-primary transition-colors" id="name" placeholder="Seu nome completo" type="text"/>
</div>
<div>
<label class="text-white/80 text-sm font-medium mb-2 block" for="email">E-mail</label>
<input class="w-full bg-[#283039] border border-transparent rounded-lg text-white placeholder-white/50 focus:ring-primary focus:ring-2 focus:border-primary transition-colors" id="email" placeholder="seu.email@exemplo.com" type="email"/>
</div>
<div>
<label class="text-white/80 text-sm font-medium mb-2 block" for="phone">Telefone</label>
<input class="w-full bg-[#283039] border border-transparent rounded-lg text-white placeholder-white/50 focus:ring-primary focus:ring-2 focus:border-primary transition-colors" id="phone" placeholder="(XX) XXXXX-XXXX" type="tel"/>
</div>
<div>
<label class="text-white/80 text-sm font-medium mb-2 block" for="company">Empresa</label>
<input class="w-full bg-[#283039] border border-transparent rounded-lg text-white placeholder-white/50 focus:ring-primary focus:ring-2 focus:border-primary transition-colors" id="company" placeholder="Nome da sua empresa" type="text"/>
</div>
